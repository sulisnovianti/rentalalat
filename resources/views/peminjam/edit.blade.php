...
<div class="form-group">
				...
				<input type="date" name="a" value="{{$peminjam->tgl_pinjam}}" class="form-control" required="">
			</div>
			...
			<div class="form-group">
				...
				<input type="text" name="c" class="form-control"  value="{{$peminjam->jumlah_hari}}"   required="">
			</div>
